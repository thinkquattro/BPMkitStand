# -*- coding: utf-8 -*-
"""Тесты GAP-436/437/442 — честная карточка «Обновления BPMkit».
...
* **GAP-436** — `restart_required` выставлялся подменой файла (`apply_staged`/
...
# ==========================================================================================
# GAP-436.0: read_runtime_marker — чтение маркера, best-effort
# ==========================================================================================
@pytest.fixture()
...
def test_read_runtime_marker_missing_file_is_none(marker_path):
    assert releases.read_runtime_marker() is None, (
        "старый сервер, ни разу не перезапускавшийся после апгрейда с GAP-436, "
...
# ==========================================================================================
# GAP-436.1: _reconcile_restart_required — снятие вечной плашки
# ==========================================================================================
